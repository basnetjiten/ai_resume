...
class ResumeFileRepoImpl extends BaseRepository implements ResumeFileRepository {
  ...
  EitherFileOrError<File> pickPdfFile() async {
    final (File? pickedFile, String? errorMessage) = await _filePickerService.pickFileFromPhone();
  ...
  EitherResponse<String> uploadFile({
    ...
    return processApiCall(
      ...
      onSuccess: (bool status) => fileName,
    );
  }
}
