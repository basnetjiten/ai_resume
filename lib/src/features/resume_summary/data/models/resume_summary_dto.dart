...
abstract class ResumeSummaryDto with _$ResumeSummaryDto {
  ...
  const factory ResumeSummaryDto({required bool success, required ResumeSummaryDataDto data}) = _ResumeSummaryDto;

  factory ResumeSummaryDto.fromJson(Map<String, dynamic> json) => _$ResumeSummaryDtoFromJson(json);
}
...
abstract class ResumeSummaryDataDto with _$ResumeSummaryDataDto {
  ...
  factory ResumeSummaryDataDto.fromJson(Map<String, dynamic> json) => _$ResumeSummaryDataDtoFromJson(json);
}
...
abstract class RiskFactorDto with _$RiskFactorDto {
  @JsonSerializable(explicitToJson: true)
  const factory RiskFactorDto({required String score, required String explanation}) = _RiskFactorDto;

  factory RiskFactorDto.fromJson(Map<String, dynamic> json) => _$RiskFactorDtoFromJson(json);
}

@freezed
abstract class RewardFactorDto with _$RewardFactorDto {
  @JsonSerializable(explicitToJson: true)
  const factory RewardFactorDto({required String score, required String value, required String fit}) = _RewardFactorDto;

  factory RewardFactorDto.fromJson(Map<String, dynamic> json) => _$RewardFactorDtoFromJson(json);
}
