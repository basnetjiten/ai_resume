...
class StatCardWidget extends StatelessWidget {
  const StatCardWidget({required this.title, required this.value, required this.icon, super.key, this.color});
  ...
  Widget build(BuildContext context) {
    final Color textColor = color ?? Theme.of(context).primaryColor;
