...
class CVAnalysisScreen extends StatefulWidget {
  ...
  CVAnalysisScreen({required this.fileName});
...
class CVSummaryScreen extends StatefulWidget {
  @override
  _CVSummaryScreenState createState() => _CVSummaryScreenState();
}

class _CVSummaryScreenState extends State<CVSummaryScreen>
    with TickerProviderStateMixin {
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  _buildStatCard(
                      'Total CVs', '${allCVs.length}', Icons.description),
                  _buildStatCard('Pages', '$totalPages', Icons.pages),
                  _buildStatCard(
                      'Current', '${currentPage + 1}', Icons.bookmark),
                ],
              ),
            ),
                          ...
                          builder: (context, value, child) {
                            return Transform.translate(
                              ...
                              child: Opacity(
                                opacity: value.clamp(0.0, 1.0),
                                child:
                                    _buildCVCard(currentPageCVs[index], index),
                              ),
                            );
                          },
                        );
  ...
  static List<CVSummaryData> _generateMockCVData() {
    return [
      CVSummaryData(
        ...
        experience: 'Senior',
        summary:
            'Experienced mobile developer with expertise in Flutter and React Native. Led multiple successful app launches with 1M+ downloads.',
      ...
      CVSummaryData(
        ...
        summary:
            'Full-stack developer specializing in web applications using React, Node.js, and modern cloud technologies.',
      ...
      CVSummaryData(
        ...
        experience: 'Senior',
        summary:
            'Creative UI/UX designer with 7+ years experience creating intuitive and beautiful user interfaces for mobile and web.',
        skills: [
          'Figma',
          'Adobe XD',
          'Prototyping',
      ...
      CVSummaryData(
        ...
        experience: 'Mid-level',
        summary:
            'Native iOS developer with strong Swift skills and experience building scalable applications for the App Store.',
      ...
      CVSummaryData(
        ...
        experience: 'Senior',
        summary:
            'Strategic product manager with expertise in mobile app development lifecycle and agile methodologies.',
        skills: [
          'Product Strategy',
          'Agile',
          'Analytics',
      ...
      CVSummaryData(
        ...
        experience: 'Junior',
        summary:
            'Backend engineer focused on building scalable APIs and microservices using modern frameworks.',
      ...
      CVSummaryData(
        ...
        experience: 'Mid-level',
        summary:
            'Data scientist with expertise in machine learning and statistical analysis for business insights.',
      ...
      CVSummaryData(
        ...
        experience: 'Senior',
        summary:
            'DevOps engineer specializing in cloud infrastructure, CI/CD pipelines, and automation.',
      ...
      CVSummaryData(
        ...
        experience: 'Junior',
        summary:
            'Frontend developer passionate about creating responsive and accessible web applications.',
      ...
      CVSummaryData(
        ...
        experience: 'Senior',
        summary:
            'Mobile architect with extensive experience designing scalable mobile application architectures.',
